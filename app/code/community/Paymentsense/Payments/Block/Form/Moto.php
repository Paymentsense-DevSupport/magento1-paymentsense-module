...
/**
 * Form block for Paymentsense Moto
 */
class Paymentsense_Payments_Block_Form_Moto extends Mage_Payment_Block_Form
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('paymentsense/form/moto.phtml');
    }
