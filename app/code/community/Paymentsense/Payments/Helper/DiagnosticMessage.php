 ...
 */
class Paymentsense_Payments_Helper_DiagnosticMessage extends Mage_Core_Helper_Abstract
{
    /**
     * CSS class names
     */
    ...
    {
        return $this->buildMessage($this->__($text), self::SUCCESS_CLASS_NAME, self::MESSAGE_TYPE_STATUS);
    }
    ...
    {
        return $this->buildMessage($this->__($text), self::WARNING_CLASS_NAME, self::MESSAGE_TYPE_STATUS);
    }
    ...
    {
        return $this->buildMessage($this->__($text), self::ERROR_CLASS_NAME, self::MESSAGE_TYPE_STATUS);
    }
    ...
    {
        return $this->buildMessage($this->__($text), self::SUCCESS_CLASS_NAME, self::MESSAGE_TYPE_CONNECTION);
    }
    ...
    {
        return $this->buildMessage($this->__($text), self::WARNING_CLASS_NAME, self::MESSAGE_TYPE_CONNECTION);
    }
    ...
    {
        return $this->buildMessage($this->__($text), self::ERROR_CLASS_NAME, self::MESSAGE_TYPE_CONNECTION);
    }
    ...
    {
        return $this->buildMessage($this->__($text), self::SUCCESS_CLASS_NAME, self::MESSAGE_TYPE_SETTINGS);
    }
    ...
    {
        return $this->buildMessage($this->__($text), self::WARNING_CLASS_NAME, self::MESSAGE_TYPE_SETTINGS);
    }
